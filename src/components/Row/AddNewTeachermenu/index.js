...
import { Row, Text, Img, Button, Column } from "components";

const AddNewTeachermenu = (props) => {
  return (
    <>
      <Row className={props.className}>
        ...
        <Img
          src="images/img_notification_5.png"
          className="lg:h-[32px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] lg:ml-[447px] xl:ml-[559px] 2xl:ml-[629px] 3xl:ml-[755px] lg:w-[32px] xl:w-[40px] 2xl:w-[45px] 3xl:w-[54px]"
          alt="notification"
        />
...
export default AddNewTeachermenu;
