...
const StudentDetails4 = (props) => {
  return (
    <>
      <aside className={props.className}>
        <Column className="">
          <Column className="bg-colors1 justify-start lg:pb-[178px] xl:pb-[222px] 2xl:pb-[250px] 3xl:pb-[300px] lg:pt-[26px] xl:pt-[33px] 2xl:pt-[37px] 3xl:pt-[45px] w-[100%]">
            ...
            <Column className="justify-start lg:mt-[54px] xl:mt-[68px] 2xl:mt-[76px] 3xl:mt-[91px] w-[85%]">
              <Column className="items-center w-[100%]">
                <Text className="Group87" variant="body1">
                  Akademi - School Admission Dashboard
                </Text>
              </Column>
              <Text className="Madewithby" variant="body1">
